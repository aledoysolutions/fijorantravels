...
$query = "select * from product where token = '$token'";
  ...
  <div class="wrapper">
    ...
    <main class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Edit Products</div>
        <div class="ps-3">
      ...
      <form action="./proc_edit_products" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">                
                ...
                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Destination Name</span>
                  <input type="text" class="form-control" name="destination" value="<?php echo $row['destination']; ?>"
                    aria-label="product_name" aria-describedby="basic-addon1">
                </div>
                ...
                <div class="input-group mb-3" style="margin-top:20px"> <span class="input-group-text" id="basic-addon1">Image</span>
                  <input type="file" class="form-control" name="image_path" aria-label="image_path"
                    aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3"> <img src="<?php echo $row['image_path']; ?>" alt="" style="height:80px">
                </div>

                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Image2</span>
                  <input type="file" class="form-control" name="image_path2" aria-label="image_path2"
                    aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3"> <img src="<?php echo $row['image_path2']; ?>" alt="" style="height:80px">
                </div>
                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Image3</span>
                  <input type="file" class="form-control" name="image_path3" aria-label="image_path3"
                    aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3"> <img src="<?php echo $row['image_path3']; ?>" alt="" style="height:80px">
                </div>
