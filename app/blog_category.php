    ...
    ?>
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="./category"> <button type="button" class="btn btn-primary">Add
                                Category</button></a>
                    </div>
                </div>
            </div>
                    ...
                    <form action="delete-blog.php" method="post">
                        ...
                        <div class="table-responsive mt-3">
                            <table class="table table-bordered align-middle">
                                ...
                                ?>
                                    <tr>
                                        <td> <input type="checkbox" value="yes" name="id"></td>
                                        <td> <?php echo $row['cat_name']; ?></td>
                                        <td><a href="delete-category.php?id=<?php echo $row['id']; ?>"
                                                onclick="return confirm('Are you sure you want to delete this location?')"
                                                class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                title="Delete"><i class="bi bi-trash-fill"></i></a></td>
                                    </tr>
                                    <?php 
                                    }
                                    ?>
