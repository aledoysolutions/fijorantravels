          ...
          <div class="col-xl-9 mx-auto">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Blog Title</span>
                  <input type="text" class="form-control" name="title" value="<?php echo $blog_title; ?>" placeholder="Blog Title" aria-label="Banner Text" aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Location</span>
                  <input type="text" class="form-control" name="location" value="<?php echo $location; ?>" placeholder="Location" aria-label="Banner Text" aria-describedby="basic-addon1">
                </div>
                ...
                <textarea type="text" class="form-control" id="editor" aria-label="Content" cols="30" rows="10"
                  aria-describedby="basic-addon1" name="blog_content"><?php echo $row['blog_content']; ?></textarea>
                ...
                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">date_posted	</span>
                  <input type="date" class="form-control" name="date_posted" aria-label="image_path2" aria-describedby="basic-addon1">
                </div>
