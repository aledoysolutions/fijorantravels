...
<body>
    ...
    ?>
        ...
        <main class="page-content">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="./blog_category">
                            <button type="button" class="btn btn-primary">View Category</button></a>
            ...
            <form action="./proc_add_category" method="POST" enctype="multipart/form-data">
              ...
              echo '<div class="alert alert-success">' . $success . '</div>';
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Category
                                        Name</span>
                                    <input type="text" class="form-control" name="category"
                                        value="<?php echo $category; ?>" placeholder="Category Name"
