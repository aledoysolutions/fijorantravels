  ...
  <div class="wrapper">
    ...
    <main class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
          <div class="btn-group">
            <a href="./product_form"> <button type="button" class="btn btn-primary">Add Products</button></a>
          </div>
        </div>
      </div>
      <!--end breadcrumb-->
          ...
          <form action="delete" method="post">
            <div class="d-flex align-items-center">
              ...
              <div class="ms-auto position-relative">
                ...
                <input type="submit" class="btn btn-outline-danger" onclick="return confirm('Are you sure you want to delete this product?');" id="delete2" value="Delete">
              </div>
            </div>
            <div class="table-responsive mt-3">
              <table class="table table-bordered align-middle">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <td><input type="checkbox" name="check_id[]" value="<?php echo $row['id']; ?>" id="del<?= $i ?>"></td>
                      <td><?php echo $row['destination']; ?></td>
                      <td><?php echo substr($row['destinationLocation'], 0, 20); ?>...</td>
                      <td><?php echo $row['price']; ?></td>
                      <td><img src="<?php echo $row['image_path']; ?>" style="height:80px" alt=""></td>
                      <td><img src="<?php echo $row['image_path2']; ?>" style="height:80px" alt=""></td>
                      <td><img src="<?php echo $row['image_path3']; ?>" style="height:80px" alt=""></td>

                      <td>
                        <div class="table-actions d-flex align-items-center gap-3 fs-4">
                          <a href="edit-products?token=<?php echo $row['token']; ?>" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i></a>
                          <a href="delete?token=<?php echo ($row['token']); ?>&tab=<?= base64_encode('product'); ?>&return=<?= base64_encode('product'); ?> " onclick="return confirm('Are you sure you want to delete this location?')" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><i class="bi bi-trash-fill"></i></a>
                        </div>
                      </td>
                    </tr>
                </tbody>
