    ...
    <main class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
          <div class="btn-group">
            <a href="./product">
              <button type="button" class="btn btn-primary">View Products</button></a>
      ...
      <form action="./proc_add_productform" method="POST" enctype="multipart/form-data">
          ...
          <div class="col-xl-9 mx-auto">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Destination Name</span>
                  <input type="text" class="form-control" name="destination" value="<?php echo $destination; ?>" placeholder="Product Name" aria-label="Banner Text" aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Price</span>
                  <input type="text" class="form-control" name="price" value="<?php echo $price; ?>" placeholder="Price" aria-label="Banner Text" aria-describedby="basic-addon1">
                </div>


                <span class="input-group-text" id="basic-addon1">Destination Location</span>
                <textarea type="text" class="form-control" id="editor" aria-label="Content" cols="30" rows="10"
                  aria-describedby="basic-addon1" name="destinationLocation"><?php echo $row['destinationLocation']; ?></textarea>
                ...
                <div class="input-group mb-3" style="margin-top:20px"> <span class="input-group-text" id="basic-addon1">Image Path</span>
                  <input type="file" class="form-control" name="image_path" aria-label="image_path" aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Image Path2</span>
                  <input type="file" class="form-control" name="image_path2" aria-label="image_path2" aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Image Path3</span>
