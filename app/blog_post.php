                ...
                <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto position-relative">
                                ...
                                <input type="submit" class="btn btn-outline-danger"
                                    onclick="return confirm('Are you sure you want to delete this Blog?');" id="delete2"
                                    value="Delete">
                            </div>
                        </div>
                  ...
                  ?>
                                    <tr>
                                        ...
                                        <td><?php echo strip_tags(substr($row['content'], 0, 20)); ?>...</td>
                                        ...
                                        <td>
                                            <div class="table-actions d-flex align-items-center gap-3 fs-4">
                                                <a href="edit-blog?token=<?php echo $row['token']; ?>"
                                                    class="text-warning" data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" title="Edit"><i
                                                        class="bi bi-pencil-fill"></i></a>
                                                <a href="delete-post?token=<?php echo ($row['token']); ?>"
