  ...
  <div class="wrapper">
    ...
    <main class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
          <div class="btn-group">
            <a href="./blog_form.php"> <button type="button" class="btn btn-primary">Add Blogs</button></a>
          </div>
        </div>
      </div>
      <!--end breadcrumb-->
          ...
          <form action="delete" method="post">
            <div class="d-flex align-items-center">
              ...
              <div class="ms-auto position-relative">
                ...
                <input type="submit" class="btn btn-outline-danger" onclick="return confirm('Are you sure you want to delete this Blog?');" id="delete2" value="Delete">
              </div>
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td> <img src="<?php echo $row['blog_img']; ?>" width="200" > </td>
                      <td><?php echo long_date($row['date_posted']); ?></td>
