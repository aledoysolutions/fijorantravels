                ...
                <li>
                   <a class="dropdown-item" href="#">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                          <h6 class="mb-0 dropdown-user-name"><?php echo ucwords($_SESSION['cms_user']); ?></h6>
                          <small class="mb-0 dropdown-user-designation text-secondary"><?php echo ucwords($_SESSION['privilege']); ?></small>
                        </div>
                     </div>
                   </a>
                 </li>
